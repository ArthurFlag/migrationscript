...
class TestConvert(unittest.TestCase):
    ...
    def test_codeblock_title(self):

        input_file_path = os.path.join(
            os.path.dirname(__file__), "md_files", "code_block_titles.md"
        )
        expected_output_file_path = os.path.join(
            os.path.dirname(__file__),  "md_files", "code_block_titles_expected.md"
        )

        with open(input_file_path, "r", encoding="utf-8") as input_file:
            input_content = input_file.read()

        fixed_content = fix_codeblock_title(input_content)
    ...
    def test_process_grid(self):
        ...
        input_file_path = os.path.join(
            os.path.dirname(__file__), "md_files", "grid_test.md"
        )
        expected_output_file_path = os.path.join(
            os.path.dirname(__file__),  "md_files", "grid_expected.md"
        )

        with open(input_file_path, "r", encoding="utf-8") as input_file:
            input_content = input_file.read()

        fixed_content = process_grids(input_content)
